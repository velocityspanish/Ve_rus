...
def generate_caption(phrases, category, platform="facebook"):
    ...
    if platform == "facebook":
        ...
        caption_lines = [
            f"🇷🇺 Learn Russian with Velocity Russian! 🇷🇺",
            f"",
            f"📚 Category: {category}",
            f"",
            f"🎯 Master Russian one phrase at a time! Today's {category} lesson:",
            f""
        ]
        ...
        caption_lines.extend([
            ...
            f"🔔 Follow for daily Russian lessons!",
            f"",
...
def upload_to_all_platforms(video_path, caption, category):
    ...
    print("\n" + "="*80)
    print("🚀 VELOCITY RUSSIAN - MULTI-PLATFORM UPLOAD")
    print("="*80)
...
def main():
    ...
    print("\n" + "="*80)
    print("🇷🇺 VELOCITY RUSSIAN - AUTOMATED UPLOAD 🇷🇺")
    print("="*80)
