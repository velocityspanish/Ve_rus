...
def generate_video_metadata(category: str, num_phrases: int):
    """Generate Russian title, description, and tags for the video"""

    title = f"Учим Русский: {num_phrases} Essential {category} Фраз 🇷🇺"

    description = f"""Learn {num_phrases} essential Russian phrases for {category}!

Perfect for beginners learning Russian. Each phrase includes:
✅ English phrase
✅ Russian translation
✅ Pronunciation guide
✅ Usage context

Subscribe for daily Russian lessons!

#LearnRussian #RussianLessons #RussianForBeginners #LanguageLearning
#Russian #Education #Tutorial #DailyRussian #{category.replace(' ', '')}
"""
...
def upload_to_youtube(video_path, title, description, tags=None, category_id='27'):
    ...
    if tags is None:
        tags = ['learn russian', 'russian lessons']
...
def main():
    ...
    # Generate Russian metadata for test
    title = "Учим Русский: 5 Essential Motivation Фраз 🇷🇺"
    description = "Learn 5 essential Russian phrases for Motivation! #LearnRussian #RussianLessons"
    tags = ['learn russian', 'russian lessons', 'motivation']
